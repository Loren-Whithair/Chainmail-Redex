...
(define (test-ClassDesc)
  ...
  (define false_Class (list
                       ...
                       (term (clss C() { (constructor() { () }) (fld f)  (method m() { () }) (ghost f(x y) { x }) }))
                       (term (clss C() { (fld f) (method m() { () }) (constructor() { () }) (ghost f(x y) { x }) }))
                       (term (clss C() { (fld f) (constructor() { () }) (ghost f(x y) { x }) (method m() { () }) }))
                       ))
