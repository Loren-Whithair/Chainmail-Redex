...
(define (test-methCall_OS)
 ...
 (test-->
  ...
  (test-->  ;; x_1 not an addr (i.e. not an object)
   expr-reductions
   (term ((mt [C1 -> (clss C1() { (method m_0() { (return something) }) })]) ;;Module
          (((((x_0 := x_1 @ m_0()) $ ()) ((mt [x_1 -> null]) [this -> 1])) · (() mt)) ;;Stack
  ...
  (test-->  ;; (M-Match M C_1) ≠ #t    - the class of x_1 is not defined in M
   expr-reductions
   (term ((mt [C2 -> (clss C2() { (method m_0() { (return something) }) })]) ;;Module
          (((((x_0 := x_1 @ m_0()) $ ()) ((mt [x_1 -> 2]) [this -> 1])) · (() mt)) ;;Stack
           ((mt [1 -> (C1 mt)]) [2 -> (C1 mt)])))) ;; Heap
   ;;nothing
   )
